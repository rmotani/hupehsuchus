...
pdf(h=4.5, w=4, file="AllLM_Fang.pdf")
...
pdf(h=11,w=11,file="PCA_Fang_wNames.pdf")
  chplot(pca.coord[,1],pca.coord[,2],cl2,plotlegend=F,xlab="PC 1",ylab="PC2")
  textxy(pca.coord[,1],pca.coord[,2],fnames2)
dev.off()

plotLD(shape.data,file="LM_Fang.pdf")
...
pdf('Bt_Fang.pdf', width=9, height=6.5)
