...
CET <- DAT[DAT$Clade1 == "Cetacea",]
 ...
 rmv <- c("Balaenoptera_borealis",
         ...
         "Feresa_attenuata",
         "Delphinus_delphis")
 for(i in 1:length(rmv)) CET <- CET[rownames(CET) != rmv[i],]
...
pdf('Bt_Fang_Cetacea_wo19.pdf', width=9, height=6.5)
